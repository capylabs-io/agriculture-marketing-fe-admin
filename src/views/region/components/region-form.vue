  ...
  <v-form v-model="regionStore.regionForm">
    <v-row class="">
      ...
      <v-col cols="12" md="7">
        <v-file-input
          ...
          v-model="regionStore.region.thumbnail"
    ...
    <v-row class="mt-3">
      ...
      <v-col cols="12" md="7">
        <v-select
          class="border-radius-8"
          v-model="regionStore.region.regionCategory"
          :rules="[$rules.required]"
    ...
    <v-row class="mt-3">
      ...
      <v-col cols="12" md="7">
        <v-file-input
          v-model="regionStore.region.certification"
          placeholder="Chọn ảnh"
          prepend-inner-icon="mdi-paperclip"
          class="border-radius-8"
          ref="myfile"
  ...
  computed: {
    ...
    getregionImage() {
      if (
        ...
        !this.regionStore.file
      )
        return this.regionStore.region.thumbnail;
      if (!this.regionStore.file) return require("@/assets/no-image.png");
      return URL.createObjectURL(this.regionStore.file);
    },
    getCertificationImage() {
      if (
        this.regionStore.region &&
        this.regionStore.region.certification.quality
      )
        return this.regionStore.region.certification.quality;
      if (!this.regionStore.certification.quality)
